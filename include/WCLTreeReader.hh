...
class WCLTreeReader : public TObject {
 ...
 public: 
  ...
  void SetPMTBranchAddys();
  void LoadPMT(Int_t iPMT);
  ...
  Int_t get_PMTid() {return pmt_id;}
  Double_t get_PMTx() {return pmt_pos_x;}
  Double_t get_PMTy() {return pmt_pos_y;}
  Double_t get_PMTz() {return pmt_pos_z;}
  Double_t get_PMTsize() {return pmt_size;}
  Double_t get_PMTqe() {return pmt_qe;}
  Double_t get_PMTtimeRes() {return pmt_time_res;}
  Int_t get_IsLAPPD() {return is_lappd;}

  // PMT hit info
  Int_t* get_hitPMTid() {return hit_PMTid;}
  Double_t* get_hitTime() {return hit_time;}
  Double_t* get_hitX() {return hit_x;}
  Double_t* get_hitY() {return hit_y;}
  Double_t* get_hitZ() {return hit_z;}
 ...
 private:
  ...
  //pmt tree variables
  int pmt_id, is_lappd;
  double pmt_pos_x, pmt_pos_y, pmt_pos_z, pmt_size, pmt_qe, pmt_time_res;
