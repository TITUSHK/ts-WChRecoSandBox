...
class WChRecoLite : public TObject {
 ...
 double Amotry(double p[5][4], double y[], int ndim, double psum[], const int ihi, const double fac);

 void Amoeba(double p[5][4], double y[], int ndim, const double ftol, int &nfunk);

 double MeanVertexSeed(int dir);
 ...
 void GetP(double p[5][4]);

 double GetSumVtx(double vertex[4]);
