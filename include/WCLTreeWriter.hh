...
class WCLTreeWriter : public TObject {
 ...
 public: 
  ...
  void AddPMT(int id, double x, double y, double z, double size, double qe, double tRes, int isLAPPD);
  void AddHit(double time, double x, double y, double z, int pmtId);
