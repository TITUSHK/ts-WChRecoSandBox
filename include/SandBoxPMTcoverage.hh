...
//			double zl, double zh);
  ...
  void SetWallConfiguration(int mcase, int mmode, int mshapePMT, double msizePMT, double NrowPMT, double NcolPMT,
  ...
  int isActiveHit(double mx, double my, double mz, double wavelength, int &whichPhotoSensor, bool LAPPDs);

  int isActiveHitC(int mcase, double xx1, double xx2, double wavelength, int &whichPhotoSensor, bool LAPPDs);
 ...
 private: 
  ...
  Double_t _QE_PMT[7];
  Double_t _QE_WAVELENGTHS_PMT[7][20];
  Double_t _QE_FACTOR_PMT[7][20];
